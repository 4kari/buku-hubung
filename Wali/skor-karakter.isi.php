                ...
                <div class="card-body col col-md-12 text-center justify-content-center">
                    <table class="table table-bordered">
                        ...
                        <?php 
                            //$id = $result['id_siswa'];
                            $no = 1;
                            $datas = mysqli_query($koneksi, "SELECT * FROM siswa WHERE wali_id='$id'");
                            while ($idsis = mysqli_fetch_array($datas)) {
                        ...
                        <?php
                            ...
                            $id_siswa = $idsis['id'];
                            $tgl = $_GET['tanggal'];
                            $data = mysqli_query($koneksi, "SELECT * FROM penilaian_siswa WHERE tanggal='$tgl' AND id_siswa='$id_siswa'");
                            while ($result = mysqli_fetch_array($data)) {
